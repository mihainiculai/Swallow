...
public class AuthenticationController(UserManager<User> userManager, SignInManager<User> signInManager,
    IUserRepository userRepository, IGoogleAuthTokenUtil googleAuthTokenUtil, AuthenticationPropertiesConfig authenticationPropertiesConfig, 
    ISubscriptionRepository subscriptionRepository, IEmailSender emailSender, IReCaptchaVerifier reCaptchaVerifier,
    IMapper mapper) : ControllerBase
{
    ...
    {
        var userInfo = await googleAuthTokenUtil.GetUserInfoAsync(googleLoginDto.AccessToken);
