...
namespace Swallow.Data.Migrations
{
    ...
    [Migration("20231025114308_UpdateMigration8")]
    partial class UpdateMigration8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Swallow.Models.PlatformSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NextCurrencyUpdate = new DateTime(2023, 10, 25, 11, 43, 8, 401, DateTimeKind.Utc).AddTicks(4135)
                        });
                });
